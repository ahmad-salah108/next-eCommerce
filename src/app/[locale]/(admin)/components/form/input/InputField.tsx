...
const Input: FC<InputProps> = ({
  ...
  if (disabled) {
    ...
    inputClasses += ` bg-transparent text-gray-800 border-gray-300 focus:border-gray-700 focus:ring-3 focus:ring-gray-700/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:focus:border-cyan-900`;
  }
