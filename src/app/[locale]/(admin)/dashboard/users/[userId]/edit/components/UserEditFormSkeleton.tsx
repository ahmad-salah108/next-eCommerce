    ...
    <ComponentCard title="">
      <div className="space-y-6">
        <div className="max-w-[500px]">
          ...
          <div className="h-11 w-full animate-pulse rounded-md bg-gray-200 dark:bg-gray-700" />
        </div>
        <div className="max-w-[500px]">
          <Label>Email</Label>
          <div className="h-11 w-full animate-pulse rounded-md bg-gray-200 dark:bg-gray-700" />
        ...
        <div className="flex justify-end">
            <div className="h-11 w-32 animate-pulse rounded-md bg-gray-200 dark:bg-gray-700" />
        </div>
      </div>
    </ComponentCard>
  );
